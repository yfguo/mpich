                                                 ...
                                                 MPIR_Request ** request, MPIR_Errflag_t * errflag)
{
    ...
    mpi_errno =
        MPIR_Allgather_init(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr,
                            info_ptr, request, errflag);
                                                  ...
                                                  MPIR_Errflag_t * errflag)
{
    ...
    mpi_errno =
        MPIR_Allgatherv_init(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype,
                             comm_ptr, info_ptr, request, errflag);
