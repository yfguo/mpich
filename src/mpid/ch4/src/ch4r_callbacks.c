                                            ...
                                            MPIR_Request ** req)
{
    ...
    MPIR_Datatype_release_if_not_builtin(MPIDIG_REQUEST(sreq, send_ext->rdr_req).datatype);
    MPID_Request_complete(sreq);
                                            ...
                                            MPIR_Request ** req)
{
    ...
    rdr_req = MPIDIG_REQUEST(sreq, send_ext->rdr_req);

    MPIDIG_REQUEST(sreq, send_ext->plreq).src_buf = rdr_req.src_buf;
    MPIDIG_REQUEST(sreq, send_ext->plreq).count = rdr_req.count;
    MPIDIG_REQUEST(sreq, send_ext->plreq).datatype = rdr_req.datatype;
    MPIDIG_REQUEST(sreq, send_ext->plreq).rank = rdr_req.rank;
    MPIDIG_REQUEST(sreq, send_ext->plreq).tag = rdr_req.tag;
    MPIDIG_REQUEST(sreq, send_ext->plreq).context_id = rdr_req.context_id;
