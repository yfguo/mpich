                                                         ...
                                                         MPI_Datatype datatype, MPIR_Request * sreq)
{
    ...
    ret = MPIDI_POSIX_am_isend_pipeline(context_id, src_rank, MPIDI_POSIX_AM_HDR_CH4, handler_id,
...
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_am_get_avail_long_protocol(const void *data, MPI_Count count,
                                                                  ...
                                                                  int *avail_protocol_bits)
{
    ...
    ret = MPIDI_POSIX_am_get_avail_long_protocol(data, count, datatype, avail_protocol_bits);
