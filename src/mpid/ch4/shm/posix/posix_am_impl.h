                                                ...
                                                const void *am_hdr, MPIR_Request * sreq)
{
    ...
    if (data_sz) {
        ...
        if (unlikely(need_packing)) {
            ...
            mpi_errno = MPIR_Typerep_pack(data, count, datatype,
                                          MPIDIG_REQUEST(sreq, send_ext->offset), payload,
                                                   ...
                                                   const void *am_hdr, MPIR_Request * sreq)
{
    ...
    if (unlikely(need_packing)) {
        ...
        MPI_Aint actual_pack_bytes;
        mpi_errno = MPIR_Typerep_pack(data, count, datatype, MPIDIG_REQUEST(sreq, send_ext->offset),
