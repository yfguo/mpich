                       ...
                       MPIDI_POSIX_am_header_t ** msg_hdr, struct iovec **iov, size_t * iov_num)
{
    ...
    MPIDU_genq_shared_queue_t *terminal;
    ...
    MPIDU_genq_shared_cell_pool_alloc(transport->cell_pool, (void **) &cell);
    ...
    MPIDU_genq_shared_queue_enqueue(terminal, transport->cell_pool, (void *) cell);
