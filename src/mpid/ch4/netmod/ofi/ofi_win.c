...
int win_allgather(MPIR_Win * win, void *base, int disp_unit);
int win_set_per_win_sync(MPIR_Win * win);
int win_init_sep(MPIR_Win * win);
int win_init_stx(MPIR_Win * win);
int win_init_global(MPIR_Win * win);
int win_init(MPIR_Win * win);
