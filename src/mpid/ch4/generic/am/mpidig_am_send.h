                                           ...
                                           size_t msg_am_hdr_sz)
{
    ...
    MPIDIG_request_create_send_ext(sreq);
    MPIDIG_REQUEST(sreq, send_ext->data_sz_left) = data_sz;
    MPIDIG_REQUEST(sreq, send_ext->offset) = 0;
                                          ...
                                          size_t msg_am_hdr_sz)
{
    ...
    MPIDIG_request_create_send_ext(sreq);
    MPIDIG_REQUEST(sreq, send_ext->plreq).src_buf = buf;
    MPIDIG_REQUEST(sreq, send_ext->plreq).count = count;
    MPIR_Datatype_add_ref_if_not_builtin(datatype);
    MPIDIG_REQUEST(sreq, send_ext->plreq).datatype = datatype;
    MPIDIG_REQUEST(sreq, send_ext->plreq).tag = carrier_am_hdr->hdr.tag;
    MPIDIG_REQUEST(sreq, send_ext->plreq).rank = carrier_am_hdr->hdr.src_rank;
    MPIDIG_REQUEST(sreq, send_ext->plreq).context_id = carrier_am_hdr->hdr.context_id;
    MPIDIG_REQUEST(sreq, send_ext->plreq).seg_next = 1; /* seg 0 is piggybacked on RTS */
    MPIDIG_REQUEST(sreq, send_ext->data_sz_left) = data_sz;
    MPIDIG_REQUEST(sreq, send_ext->offset) = 0;
                                           ...
                                           size_t msg_am_hdr_sz)
{
    ...
    MPIDIG_request_create_send_ext(sreq);
    MPIDIG_REQUEST(sreq, send_ext->rdr_req).src_buf = buf;
    MPIDIG_REQUEST(sreq, send_ext->rdr_req).count = count;
    MPIR_Datatype_add_ref_if_not_builtin(datatype);
    MPIDIG_REQUEST(sreq, send_ext->rdr_req).datatype = datatype;
    MPIDIG_REQUEST(sreq, send_ext->rdr_req).tag = carrier_am_hdr->hdr.tag;
    MPIDIG_REQUEST(sreq, send_ext->rdr_req).rank = carrier_am_hdr->hdr.src_rank;
    MPIDIG_REQUEST(sreq, send_ext->rdr_req).context_id = carrier_am_hdr->hdr.context_id;
    MPIDIG_REQUEST(sreq, send_ext->data_sz_left) = data_sz;
    MPIDIG_REQUEST(sreq, send_ext->offset) = 0;
    MPIDIG_REQUEST(sreq, rank) = rank;
